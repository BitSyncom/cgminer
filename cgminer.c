...
static char *opt_set_avalon8_core_otp;
#endif
#ifdef USE_AVALON_MINER
...
static struct opt_table opt_config_table[] = {
	...
	OPT_WITH_CBARG("--avalon8-core-otp",
		     set_avalon8_core_otp, NULL, &opt_set_avalon8_core_otp,
		     "Set Avalon8 core index for reading otp info, range:[0, 25], step: 1"),
#endif
#ifdef USE_AVALON_MINER
