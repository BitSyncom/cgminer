...
#define AVA8_DEFAULT_FREQUENCY_4	744
#define AVA8_DEFAULT_FREQUENCY_5	780
...
struct avalon8_info {
	...
	uint32_t get_asic[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_MINER_CNT][AVA8_DEFAULT_ASIC_MAX][11];
