...
#define AVA9_DEFAULT_TEMP_TARGET	70
...
#define AVA9_DEFAULT_FREQUENCY_0	0
#define AVA9_DEFAULT_FREQUENCY_1	0
#define AVA9_DEFAULT_FREQUENCY_2	0
#define AVA9_DEFAULT_FREQUENCY_3	650
...
#define AVA9_DEFAULT_FACTORY_INFO_CNT	1

#define AVA9_DEFAULT_OVERCLOCKING_CNT	1

#define AVA9_MM921_VIN_ADC_RATIO	(3.3 / 4095.0 * 25.62 / 5.62 * 1000.0 * 100.0)
#define AVA9_MM921_VOUT_ADC_RATIO	(3.3 / 4095.0 * 63.0 / 20.0 * 10000.0 * 100.0)
